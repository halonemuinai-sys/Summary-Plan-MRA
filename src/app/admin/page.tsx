            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className={`rounded-2xl p-5 border transition-all ${cardBg}`}>
                  ...
                  <h4 className={`text-xl font-black mt-2 ${isLightMode ? 'text-slate-900' : 'text-white'}`}>
                ...
                <div className={`rounded-2xl p-5 border transition-all ${cardBg}`}>
                  <span className="text-[10px] font-bold uppercase tracking-wider text-emerald-500 bg-emerald-500/10 px-2 py-0.5 rounded border border-emerald-500/20">
                    Publisher Media
                  </span>
                  <h4 className={`text-xl font-black mt-2 ${isLightMode ? 'text-slate-900' : 'text-white'}`}>
